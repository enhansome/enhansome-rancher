...
A curated list of awesome Rancher resources inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 507,771 | 🐛 106 | 📅 2026-09-02 list.
...
* [Project Plan](https://github.com/rancher/rancher/wiki/Rancher-Project-Plan) ⭐ 25,923 | 🐛 3,370 | 🌐 Go | 📅 2026-09-19
...
* [Rancher 2.0 roadmap](https://github.com/rancher/rancher/wiki/Rancher-2.0) ⭐ 25,923 | 🐛 3,370 | 🌐 Go | 📅 2026-09-19
* [Rancher 2.0 catalog](https://github.com/rancher/charts) ⭐ 431 | 🐛 20 | 🌐 Go Template | 📅 2026-09-18
...
* [k3s](https://github.com/rancher/k3s) ⭐ 33,997 | 🐛 113 | 🌐 Go | 📅 2026-09-18 - Lightweight Kubernetes. 5 less than k8s.
* [Terraform RKE](https://github.com/yamamoto-febc/terraform-provider-rke) ⚠️ Archived - Terraform provider plugin for deploying kubernetes clusters with RKE
...
* [Rancher](https://github.com/rancher/rancher) ⭐ 25,923 | 🐛 3,370 | 🌐 Go | 📅 2026-09-19
...
* [Rancher CLI](https://github.com/rancher/cli) ⭐ 393 | 🐛 14 | 🌐 Go | 📅 2026-09-18 - The Rancher Command Line Interface (CLI)is a unified tool to manage your Rancher server
...
* [Rancher GitLab deployment tool](https://github.com/cdrx/rancher-gitlab-deploy) ⭐ 429 | 🐛 9 | 🌐 Python | 📅 2021-09-07 - Painless deployment of projects built with GitLab CI onto your Rancher infrastructure
...
* [Cowpoke](https://github.com/rancher/rancher/wiki/Cowpoke-1:-Getting-Started-with-Rancher) ⭐ 25,923 | 🐛 3,370 | 🌐 Go | 📅 2026-09-19 - Get started developing
